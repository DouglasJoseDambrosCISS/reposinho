...
digo de barras da unidade tributária
-----------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------
-- Alterando:
UPDATE CLIENTE_FORNECEDOR               SET OBSGERAL                    = REPLACE(OBSGERAL              , '\x0D\x0A',   CHR(10))        WHERE OBSGERAL                  LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET OBSGERAL                    = REPLACE(OBSGERAL              , '\x0D',       CHR(10))        WHERE OBSGERAL                  LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET OBSGERAL                    = REPLACE(OBSGERAL              , '\x0A',       CHR(10))        WHERE OBSGERAL                  LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET OBSGERAL                    = REPLACE(OBSGERAL              , '\X0D\X0A',   CHR(10))        WHERE OBSGERAL                  LIKE '%\X0D\X0A%'
...
UPDATE CLIENTE_FORNECEDOR               SET REFBANCARIA                 = REPLACE(REFBANCARIA           , '\x0D\x0A',   CHR(10))        WHERE REFBANCARIA               LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFBANCARIA                 = REPLACE(REFBANCARIA           , '\x0D',       CHR(10))        WHERE REFBANCARIA               LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFBANCARIA                 = REPLACE(REFBANCARIA           , '\x0A',       CHR(10))        WHERE REFBANCARIA               LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFBANCARIA                 = REPLACE(REFBANCARIA           , '\X0D\X0A',   CHR(10))        WHERE REFBANCARIA               LIKE '%\X0D\X0A%'
...
UPDATE CLIENTE_FORNECEDOR               SET REFCOMERCIAL                = REPLACE(REFCOMERCIAL          , '\x0D\x0A',   CHR(10))        WHERE REFCOMERCIAL              LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFCOMERCIAL                = REPLACE(REFCOMERCIAL          , '\x0D',       CHR(10))        WHERE REFCOMERCIAL              LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFCOMERCIAL                = REPLACE(REFCOMERCIAL          , '\x0A',       CHR(10))        WHERE REFCOMERCIAL              LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFCOMERCIAL                = REPLACE(REFCOMERCIAL          , '\X0D\X0A',   CHR(10))        WHERE REFCOMERCIAL              LIKE '%\X0D\X0A%'
...
UPDATE CLIENTE_FORNECEDOR               SET REFPESSOAL                  = REPLACE(REFPESSOAL            , '\x0D\x0A',   CHR(10))        WHERE REFPESSOAL                LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFPESSOAL                  = REPLACE(REFPESSOAL            , '\x0D',       CHR(10))        WHERE REFPESSOAL                LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFPESSOAL                  = REPLACE(REFPESSOAL            , '\x0A',       CHR(10))        WHERE REFPESSOAL                LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFPESSOAL                  = REPLACE(REFPESSOAL            , '\X0D\X0A',   CHR(10))        WHERE REFPESSOAL                LIKE '%\X0D\X0A%'
...
UPDATE CLIENTE_FORNECEDOR               SET REFSEPROC                   = REPLACE(REFSEPROC             , '\x0D\x0A',   CHR(10))        WHERE REFSEPROC                 LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFSEPROC                   = REPLACE(REFSEPROC             , '\x0D',       CHR(10))        WHERE REFSEPROC                 LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFSEPROC                   = REPLACE(REFSEPROC             , '\x0A',       CHR(10))        WHERE REFSEPROC                 LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET REFSEPROC                   = REPLACE(REFSEPROC             , '\X0D\X0A',   CHR(10))        WHERE REFSEPROC                 LIKE '%\X0D\X0A%'
...
UPDATE CLIENTE_FORNECEDOR               SET DESCRCONTRATOSERVICO        = REPLACE(DESCRCONTRATOSERVICO  , '\x0D\x0A',   CHR(10))        WHERE DESCRCONTRATOSERVICO      LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET DESCRCONTRATOSERVICO        = REPLACE(DESCRCONTRATOSERVICO  , '\x0D',       CHR(10))        WHERE DESCRCONTRATOSERVICO      LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET DESCRCONTRATOSERVICO        = REPLACE(DESCRCONTRATOSERVICO  , '\x0A',       CHR(10))        WHERE DESCRCONTRATOSERVICO      LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE CLIENTE_FORNECEDOR               SET DESCRCONTRATOSERVICO        = REPLACE(DESCRCONTRATOSERVICO  , '\X0D\X0A',   CHR(10))        WHERE DESCRCONTRATOSERVICO      LIKE '%\X0D\X0A%'
...
UPDATE PRODUTO_ESPECIFICACAO_TECNICA    SET OBSESPECIFIC                = REPLACE(OBSESPECIFIC          , '\x0D\x0A',   x'0D' || x'0A' ) WHERE OBSESPECIFIC             LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE PRODUTO_ESPECIFICACAO_TECNICA    SET OBSESPECIFIC                = REPLACE(OBSESPECIFIC          , '\x0D',       x'0D' || x'0A' ) WHERE OBSESPECIFIC             LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE PRODUTO_ESPECIFICACAO_TECNICA    SET OBSESPECIFIC                = REPLACE(OBSESPECIFIC          , '\x0A',       x'0D' || x'0A' ) WHERE OBSESPECIFIC             LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE PRODUTO_ESPECIFICACAO_TECNICA    SET OBSESPECIFIC                = REPLACE(OBSESPECIFIC          , '\X0D\X0A',   x'0D' || x'0A' ) WHERE OBSESPECIFIC             LIKE '%\X0D\X0A%'
...
UPDATE PRODUTO_GRADE_ECOMMERCE               SET DESCRICAO        = REPLACE(DESCRICAO  , '\x0D\x0A',   CHR(10))        WHERE DESCRICAO      LIKE '%\x0D\x0A%'
GO
COMMIT
GO
UPDATE PRODUTO_GRADE_ECOMMERCE               SET DESCRICAO        = REPLACE(DESCRICAO  , '\x0D',       CHR(10))        WHERE DESCRICAO      LIKE '%\x0D%'
GO
COMMIT
GO
UPDATE PRODUTO_GRADE_ECOMMERCE               SET DESCRICAO        = REPLACE(DESCRICAO  , '\x0A',       CHR(10))        WHERE DESCRICAO      LIKE '%\x0A%'
GO
COMMIT
GO
UPDATE PRODUTO_GRADE_ECOMMERCE               SET DESCRICAO        = REPLACE(DESCRICAO  , '\X0D\X0A',   CHR(10))        WHERE DESCRICAO      LIKE '%\X0D\X0A%'
